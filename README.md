# lab-reserve-app
Lab-Reserve is a full-stack MERN application designed to manage shared STEM club resources like 3D printers and electronics. It features secure user authentication and a dynamic dashboard to track real-time availability. The core engine uses backend validation logic to prevent double-bookings, ensuring database integrity and lab efficiency.
